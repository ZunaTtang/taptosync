...
export function TimelineView({ lines, currentTime, onSeekTo, onTimeUpdate, onSetMissingTime, headerAction }: TimelineViewProps) {
  ...
  return (
    <div className="app-card space-y-3">
      ...
      <div className="border border-gray-200 rounded-lg overflow-hidden">
        <div ref={timelineRef} className="max-h-[calc(100vh-320px)] min-h-[320px] overflow-y-auto">
